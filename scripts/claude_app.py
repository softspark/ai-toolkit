...
Account-enabled plugins can also sync to Claude Code 2.1.273+ when signed in
with the same Claude account. With a global ai-toolkit install, check for
duplicate plugin hooks using `ai-toolkit doctor`.
"""
