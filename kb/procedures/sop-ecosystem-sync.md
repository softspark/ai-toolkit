...
description: "Quarterly or event-triggered sync procedure for the 13 registry tools: Claude Code, Claude app, and 11 default editor integrations."
---
...
```bash
# Full check (all 13 registry tools, online)
