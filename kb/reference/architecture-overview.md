...
| TeammateIdle | Agent Teams: idle | *(inline)* | Completeness reminder; stop the agent once its final report is in |
...
| V Resource Governance | No destructive commands without confirmation, stay in model tier, stop finished agents |
